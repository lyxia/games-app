...
import { Creation } from './CreationHistory.tsx';
                ...
                <>
                    {creation.originalImage && (
                         <button 
                            ...
                            title={showSplitView ? "仅显示应用" : "对比原图"}
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center p-8 w-full">
             ...
             <div className="w-full max-w-md space-y-8">
                <div className="flex flex-col items-center">
                    ...
                    <h3 className="text-zinc-100 font-mono text-lg tracking-tight">构建运行环境</h3>
                ...
                <div className="w-full h-1 bg-zinc-800 rounded-full overflow-hidden">
                 ...
                 <div className="border border-zinc-800 bg-black/50 rounded-lg p-4 space-y-3 font-mono text-sm">
                     <LoadingStep text="分析视觉输入" active={loadingStep === 0} completed={loadingStep > 0} />
                     <LoadingStep text="识别界面模式" active={loadingStep === 1} completed={loadingStep > 1} />
                     <LoadingStep text="生成功能逻辑" active={loadingStep === 2} completed={loadingStep > 2} />
                     <LoadingStep text="编译预览" active={loadingStep === 3} completed={loadingStep > 3} />
                 </div>
             </div>
          </div>
        ) : creation?.html ? (
