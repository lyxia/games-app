...
一个专为小学生设计的互动学习游戏平台，包含英语语法和数学专项训练游戏。

## 📚 项目简介

这是一个基于 React + Vite 构建的教育游戏平台，旨在通过有趣的互动游戏帮助小学生学习英语语法和数学知识。项目采用模块化设计，每个游戏都是独立的模块，便于维护和扩展。

## ✨ 功能特性

- 🎮 **丰富的游戏内容**：包含多个英语语法和数学专项训练游戏
...
1. 在 `english/` 或 `math/` 目录下创建新的游戏文件夹
